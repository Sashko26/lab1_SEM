class Eurozone {
	...
	checkNeighboringNodes(rect1, rect2) {
		...
		if (
		  (rect1.xl === rect2.xh + 1 && rect1.yl <= rect2.yh && rect1.yh >= rect2.yl) || // сусідній зліва
		  (rect1.yl === rect2.yh + 1 && rect1.xl <= rect2.xh && rect1.xh >= rect2.xl) || // сусідній знизу
		  (rect1.xh === rect2.xl - 1 && rect1.yl <= rect2.yh && rect1.yh >= rect2.yl) || // сусідній справа
		  (rect1.yh === rect2.yl - 1 && rect1.xl <= rect2.xh && rect1.xh >= rect2.xl) // сусідній зверху
		) {
		  return true;
		}
		return false;
